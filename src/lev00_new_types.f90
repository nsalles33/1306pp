...
! =================================================================================================
  ...
  module hidden_table
    use iso_c_binding
    implicit none
    integer( c_int ), dimension(:), target, allocatable :: h_i_state, h_f_state, h_site, h_nneig, h_nevt, h_neig, h_event_site
    !integer( c_int ), dimension(:,:), target, allocatable :: h_neig, h_event_site
    real( c_double ), dimension(:), target, allocatable :: h_rate, h_prop, h_ebarrier, h_de, h_event_rate
